...
enum Theme {
    static let accent = Color(hex: "#B25A2E")
    static let accentSecondary = Color(hex: "#4A6670")
    static let background = Color(hex: "#EFE7DD")
    static let cardBackground = Color.white.opacity(0.7)
    static let textPrimary = Color(hex: "#B25A2E").opacity(0.95)
